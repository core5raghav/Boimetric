...
import { Menu, X, ChevronDown, Fingerprint, Smile, Wifi, Utensils, Shield, Lock, DoorOpen, ArrowLeftRight, Users, AlertTriangle, Briefcase, Scan, Building2, DoorClosed, Hotel } from 'lucide-react';
import { getAllCategories } from '../data/productsDatabase';

const iconMap = {
  Fingerprint, Smile, Wifi, Utensils, Shield, Lock, DoorOpen, 
  ArrowLeftRight, Users, AlertTriangle, Briefcase, Scan, 
  Building2, DoorClosed, Hotel
};
...
const Navbar = ({ navigate, currentRoute }) => {
  ...
  return (
    <nav className={`fixed top-0 w-full z-50 transition-all duration-200 ${isScrolled ? 'bg-white/95 backdrop-blur-md shadow-sm' : 'bg-white'}`}>
